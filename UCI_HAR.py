...
feature_name_df = pd.read_csv("C:/Users/bizza/features.csv",
                              sep='\s+',
                              header=None,
...
def get_human_dataset():
    feature_name_df = pd.read_csv("C:/Users/bizza/features.csv", sep='\s+',
    ...
    X_train = pd.read_csv("C:/Users/bizza/UCI HAR Dataset/UCI HAR Dataset/train/X_train.txt", sep='\s+',
                          names=feature_name)
    X_test = pd.read_csv("C:/Users/bizza/UCI HAR Dataset/UCI HAR Dataset/test/X_test.txt", sep='\s+',
                         names=feature_name)
    y_train = pd.read_csv("C:/Users/bizza/UCI HAR Dataset/UCI HAR Dataset/train/y_train.txt", sep='\s+',
                          header=None, names=['action'])
    y_test = pd.read_csv("C:/Users/bizza/UCI HAR Dataset/UCI HAR Dataset/test/y_test.txt", sep='\s+',
                         header=None, names=['action'])
